...
eDirection direction;                                     // Variable to store current direction
...
void Draw()
{
    ...
    for(int i=0; i<fieldHeight+2; i++)                                   // Iterate through rows
    {
        for(int j=0; j<fieldWidth+2; j++)                                // Iterate through columns
        {
            ...
            else
            {
                ...
                if(tailPrint == false)                                           // Draw empty spaces
                    std::cout<<' ';
            }
        }
        std::cout<<std::endl;
